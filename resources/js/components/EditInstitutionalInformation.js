...
class EditCategory extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            title: '',
            url: '',
            pTitle: 'Update institutional information'
        }     
    ...
    componentDidMount(){
        axios.get('/api/institute/' + this.props.match.params.id, {
            headers: {
              'Authorization': `${'ABCDEFGHIJK'}`
            }
          })
        .then(response=>{
            this.setState({title: response.data.title, url: response.data.url});
        })
        .catch((error) => {
            console.error(error)
          })
    ...
    handleFormSubmit(event){        
        ...
        axios.put('/api/institute/'+ this.props.match.params.id, {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 col-xs-12">
                                        <div className="form-group">
                                            ...
                                            {this.validator.message('url', this.state.url, 'required', { className: 'text-danger' })}
